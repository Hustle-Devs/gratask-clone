...
// export default function Hero() {
//   return (
//     <div className="relative px-4 md:px-6 lg:px-8 w-full overflow-hidden">
//       {/* Left Content in container */}
//       <div className="z-10 relative flex md:flex-row flex-col justify-between items-center mx-auto max-w-custom min-h-[700px]">
//         <div className="flex items-center w-full md:w-1/2">
//           <div className="flex flex-col justify-center space-y-6 md:text-left text-center">
//             <div className="inline-flex justify-center md:justify-start items-center dark:bg-gray-700 mx-auto md:mx-0 px-3 py-1 border border-gray-600 rounded-full w-fit text-foreground dark:text-primary text-sm">
//               <span className="mr-2">
...
//       {/* Right image outside container */}
//       <div className="top-1/2 right-0 z-0 absolute w-full md:w-[50vw] max-w-[700px] -translate-y-1/2">
//         <Image
//           src={rightImage}
//           alt="Hero Image"
//           width={800}
